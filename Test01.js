...
window.addEventListener('load', e => {
    ...
    createApp({
        ...
        sceneURL: params.load || '__URL__Test01.glb'.replace('__URL__', ''),
...
function createAnnotations(app){
    ...
    // Add annotations to the scene
     // Add annotations to the scene
     handleAnnot(app, true, '1', 'annotate_1', annotate01, 'an_1', undefined);
     handleAnnot(app, true, '2', 'annotate_2', annotate02, 'an_2', undefined);
     handleAnnot(app, true, '3', 'annotate_3', annotate03, 'an_3', undefined);
