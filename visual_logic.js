...
setCSSRuleStyle('backgroundImage', 'url(\'my_image.png\')', '.v3d-simple-preloader-logo', false, '');
...
var annotation_visible, mode, id;
...
eventHTMLElem('click', 'annotation', false, function(event) {
  if (annotation_visible == false) {
    ...
    setHTMLElemStyle2('display', 'block', ['an_1', 'an_2', 'an_3'], false);
    annotation_visible = true;
  } else {
    setHTMLElemStyle2('display', 'none', ['an_1', 'an_2', 'an_3'], false);
    annotation_visible = false;
  }
});

changeVis('prompt_move_around', false);
changeVis(['GROUP', 'CubeGroup'], false);
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      ...
      arHitTest(function() {
        if (mode == 0) {
          changeVis(['GROUP', 'IndicatorGroup'], true);
          setObjTransform('IndicatorPlane', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
        }
        changeVis('prompt_move_around', false);
      }, function() {
        changeVis(['GROUP', 'IndicatorGroup'], false);
      }, 0.7);
      setHTMLElemStyle2('display', 'none', 'enter_AR_button', false);
    }, function() {
      changeVis(['GROUP', 'CubeGroup'], false);
      changeVis('prompt_move_around', false);
      setObjTransform('Cube', false, 'position', createVector(0, 0, 0), false);
      setObjDirection('Cube', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
  ...
  setHTMLElemAttribute('href', 'Test01.usdz', 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'Test01.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('IndicatorPlane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'CubeGroup'], true);
  setObjTransform('Cube', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('Cube', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
}, function() {});
